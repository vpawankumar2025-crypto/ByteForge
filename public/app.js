...
function offerCertFormHTML(kind, item){
  ...
  <div class="panel panel-wide" style="margin:0;">
    ...
    <form id="${kind}Form">
      ...
      <small style="display:block; margin:-8px 0 16px; color:var(--muted);">Tap either date field to open the calendar picker. Dates must not be in the future, and the gap between them must match this ${item.duration} program.</small>
      <div class="field">
